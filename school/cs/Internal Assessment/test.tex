...
\#\#+latex\textsubscript{header}: \usepackage \{biblatex\}
\#\#+latex\textsubscript{header}: \bibliography{bibliography}
\#\#+latex\textsubscript{header}: \bibliographystyle{plain}

\section{Abstract}
\label{sec:org1255e1d}
