...
\usepackage{capt-of}
\usepackage{hyperref}
\usepackage[bibstyle=ieeetr, hyperref=true,backref=true,maxcitenames=3,url=true,backend=biber,natbib=true] {biblatex}
