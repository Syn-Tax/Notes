...
\usepackage{capt-of}
\usepackage{hyperref}
\usepackage[bibstyle=chicago, hyperref=true,backref=true,maxcitenames=3,url=true,backend=biber,natbib=true] {biblatex}
