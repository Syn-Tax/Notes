...
\usepackage{capt-of}
\usepackage{hyperref}
\usepackage[bibstyle=plain, hyperref=true,backref=true,maxcitenames=3,url=true,backend=biber,natbib=true] {biblatex}
