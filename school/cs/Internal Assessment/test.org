...
#+latex_header: \usepackage[citestyle=authoryear-icomp,bibstyle=plain, hyperref=true,backref=true,maxcitenames=3,url=true,backend=biber,natbib=true] {biblatex}
